...
impl TryFrom<VerificationKeyBytes> for VerificationKey {
    ...
    fn try_from(bytes: VerificationKeyBytes) -> Result<Self, Self::Error> {
        // Zcash consensus rule: A MUST represent a point on the Ed25519 curve,
        // but does not need to be a canonical encoding.
...
impl VerificationKey {
    ...
    pub fn verify(&self, signature: &Signature, msg: &[u8]) -> Result<(), Error> {
        ...
        // Zcash consensus rule: R MUST represent a point on the Ed25519 curve,
        // but does not need to be a canonical encoding.
