...
class SigningKeySeedTest extends FlatSpec with MustMatchers {
  ...
  it must "wrap SigningKeySeed (RFC 8410 - PEM)" in {
    ...
    val expected_pem = BigInt("2d2d2d2d2d424547494e2050524956415445204b45592d2d2d2d2d0a4d43344341514177425159444b32567742434945494e5475637476354531684b31626259386664702b4b30362f6e776f792f48552b2b435871493945645668430a2d2d2d2d2d454e442050524956415445204b45592d2d2d2d2d", 16)
